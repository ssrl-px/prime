...
if __name__ == "__main__":
    ...
    for pickle_filename in frame_files:
        ...
        swap_dict = {
            "int02_shot-s02-A5_0_00004_20140518145014427_masked.pickle": 0,
        ...
        txt_out_head = "{0:40} {1:5.2f} {2:5.2f} {3:5.2f} {4:5.2f} {5:5.0f} {6:6.2f} {7:6.2f} {8:6.2f} {9:6.2f} {10:6.2f} {11:6.2f} {12:6.2f}".format(
    ...
    if flag_plot:
        ...
        for cc_bins, d_bins, oodsqrt_bins, cc_bin_low in zip(
            cc_bins_set, d_bins_set, oodsqr_bins_set, cc_bin_low_set
        ):
            if cc_bin_low < cc_bin_low_thres:
                plt.subplot(2, 1, 1)
                plt.plot(cc_bins)

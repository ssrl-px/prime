...
class intensities_scaler(object):
    ...
    def write_output(
        ...
        for i in range(1, iparams.n_bins + 1):
            ...
            txt_out += (
                "%02d %7.2f - %7.2f %5.1f %6.0f / %6.0f %7.2f %7.2f %7.2f %7.2f %6.0f %7.2f %6.0f %7.2f %10.2f"
                % (
                    i,
            ...
            txt_out += "\n"
            csv_out += (
                "%02d, %7.2f, %7.2f, %5.1f, %6.0f, %7.2f, %7.2f, %7.2f, %7.2f, %6.0f, %7.2f, %6.0f, %7.2f\n"
                % (
                    i,
                    binner_template_asu.bin_d_range(i)[0],
                    binner_template_asu.bin_d_range(i)[1],
        ...
        txt_out += "--------------------------------------------------------------------------------------------------------------------\n"
        txt_out += (
            "        TOTAL        %5.1f %6.0f / %6.0f %7.2f %7.2f %7.2f %7.2f %6.0f %7.2f %6.0f %7.2f %10.2f\n"
            % (

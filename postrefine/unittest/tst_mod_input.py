...
class readBadInput(unittest.TestCase):
    def testMissingData(self):
        ...
        self.assertRaises(
            mod_input.InvalidData, mod_input.process_input, ["dummy=dummier"], False
        )

    def testInvalidCrystalSystem(self):
        """mod_input should fail with invalid crystal system."""
        self.assertRaises(
            mod_input.InvalidCrystalSystem,
            mod_input.process_input,
            ["data=test_data", "target_crystal_system=dummy"],
            False,
        )
    ...
    def testMissingNumberOfResidues(self):
        ...
        self.assertRaises(
            mod_input.InvalidNumberOfResidues,
            mod_input.process_input,
            ["data=test_data"],
            False,
        )
    ...
    def testInvalidPixelSize(self):
        ...
        self.assertRaises(
            mod_input.InvalidPixelSize,
            mod_input.process_input,
            ["data=test_data", "n_residues=100"],
            False,
        )
    ...
    def testBadRunNo(self):
        ...
        self.assertRaises(
            mod_input.InvalidRunNo,
            mod_input.process_input,
            [
                "data=test_data",
                "n_residues=100",
                "pixel_size_mm=0.07934",
                "run_no=dummy_run_no",
            ],
            True,
        )
